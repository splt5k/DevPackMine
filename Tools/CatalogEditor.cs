...
// Type: DevPackMine.Tools.CatalogEditor
...
namespace DevPackMine.Tools
{
  public class CatalogEditor : Form
  {
    ...
    private void btnAddItems_Click(object sender, EventArgs e)
    {
            ...
            databaseHandle.SendQueryMySql(Host, User, Password, Database, "INSERT INTO t_ct_item (a_ctid, a_item_idx) VALUES (" + textBox1.Text + ", 19)");
            databaseHandle.SendQueryMySql(Host, User, Password, Database, "INSERT INTO t_ct_item_1 (a_ctid, a_item_idx) VALUES (" + textBox1.Text + ", 19)"); //dethunter12 add
            dgItems.Rows.Clear();
            LoadDG();
    }
    ...
    private void button2_Click(object sender, EventArgs e)
    {
            ...
            databaseHandle.SendQueryMySql(Host, User, Password, Database, "UPDATE t_catalog SET " + "a_ctname = '" + textBox2.Text + "', " + "a_category = '" + textBox3.Text + "', " + "a_type = '" + textBox4.Text + "', " + "a_subtype = '" + textBox5.Text + "', " + "a_cash = '" + textBox6.Text + "', " + "a_ctdesc = '" + textBox7.Text + "', " + "a_mileage = '" + textBox8.Text + "', " + "a_enable = '" + textBox9.Text + "', " + "a_flag = '" + textBox10.Text + "', " + "a_icon = '" + textBox11.Text + "' " + "WHERE a_ctid = '" + textBox1.Text + "'");
            databaseHandle.SendQueryMySql(Host, User, Password, Database, "UPDATE t_catalog_1 SET " + "a_ctname = '" + textBox2.Text + "', " + "a_category = '" + textBox3.Text + "', " + "a_type = '" + textBox4.Text + "', " + "a_subtype = '" + textBox5.Text + "', " + "a_cash = '" + textBox6.Text + "', " + "a_ctdesc = '" + textBox7.Text + "', " + "a_mileage = '" + textBox8.Text + "', " + "a_enable = '" + textBox9.Text + "', " + "a_flag = '" + textBox10.Text + "', " + "a_icon = '" + textBox11.Text + "' " + "WHERE a_ctid = '" + textBox1.Text + "'");
            int selectedIndex = listBox1.SelectedIndex;
      if (textBox12.Text != "")
    ...
    private void InitializeComponent()
    {
            ...
            this.exportlodToolStripMenuItem.Size = new System.Drawing.Size(127, 22);
            ...
            this.btnSaveSelected.Size = new System.Drawing.Size(60, 22);
            ...
            this.btnAddItems.Size = new System.Drawing.Size(55, 22);
            ...
            this.btnUpdateName.Size = new System.Drawing.Size(123, 22);
            ...
            this.button3.Location = new System.Drawing.Point(155, 494);
            ...
            this.button2.Location = new System.Drawing.Point(1034, 670);
            ...
            // btnShowCat1
            // 
            this.btnShowCat1.BackgroundImage = global::DevPackMine.Properties.Resources._1;
            ...
            // button4
            // 
            this.button4.BackgroundImage = global::DevPackMine.Properties.Resources._2;
            ...
            // button5
            // 
            this.button5.BackgroundImage = global::DevPackMine.Properties.Resources._3;
            ...
            // button6
            // 
            this.button6.BackgroundImage = global::DevPackMine.Properties.Resources._4;
            ...
            // button7
            // 
            this.button7.BackgroundImage = global::DevPackMine.Properties.Resources._5;
            ...
            // button8
            // 
            this.button8.BackgroundImage = global::DevPackMine.Properties.Resources._6;
            ...
            // button9
            // 
            this.button9.BackgroundImage = global::DevPackMine.Properties.Resources._7;
