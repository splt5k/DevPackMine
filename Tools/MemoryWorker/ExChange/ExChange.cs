...
namespace DevPackMine.Tools.MemoryWorker.ExChange
{
    public partial class ExChange : Form
    {
        ...
        private void LoadListBox()
        {
            ...
            while (Reader.Read())
            {
                ...
                temp.ResultItemIdx = (int)Reader["a_result_itemIndex"];
                temp.ResultItemCount = (int)Reader["a_result_itemCount"];
        ...
        private void PbSelectID1_Click(object sender, EventArgs e)
        {
            ...
            if (itemPicker.ShowDialog() != DialogResult.OK)
                return;
            textBox6.Text = itemPicker.ItemIndex.ToString();
        }
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            if (itemPicker.ShowDialog() != DialogResult.OK)
                return;
            tb_source_itemIndex0.Text = itemPicker.ItemIndex.ToString();
        }
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            if (itemPicker.ShowDialog() != DialogResult.OK)
                return;
            tb_source_itemIndex1.Text = itemPicker.ItemIndex.ToString();
        }
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            if (itemPicker.ShowDialog() != DialogResult.OK)
                return;
            tb_source_itemIndex2.Text = itemPicker.ItemIndex.ToString();
        }
        ...
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            ...
            if (itemPicker.ShowDialog() != DialogResult.OK)
                return;
            tb_source_itemIndex3.Text = itemPicker.ItemIndex.ToString();
        }
        ...
        private void pictureBox10_Click(object sender, EventArgs e)
        {
            ...
            if (itemPicker.ShowDialog() != DialogResult.OK)
                return;
            tb_source_itemIndex4.Text = itemPicker.ItemIndex.ToString();
        }
