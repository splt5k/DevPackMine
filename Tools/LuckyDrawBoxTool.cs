...
// Type: DevPackMine.Tools.LuckyDrawBoxTool
...
namespace DevPackMine.Tools
{
  public class LuckyDrawBoxTool : Form
  {
    ...
    private void btnAddItems_Click(object sender, EventArgs e)
    {
      try
      {
                databaseHandle.SendQueryMySql(Host, User, Password, Database, "INSERT INTO t_luckydrawNeed (a_luckydraw_idx, a_item_idx, a_count) VALUES (" + textBox1.Text + ", 19, 0)");
      }
      catch
      {
    ...
    private void btnDeleteSelected_Click(object sender, EventArgs e)
    {
      ...
      Convert.ToString(row.Cells["Column1"].Value);
            databaseHandle.SendQueryMySql(Host, User, Password, Database, "UPDATE t_luckydrawNeed SET " + "a_item_idx = '" + Convert.ToString(row.Cells["Column2"].Value) + "', " + "a_count = '" + Convert.ToString(row.Cells["Column4"].Value) + "' " + "WHERE a_index = '" + str + "' ");
            dgItems.Rows.Clear();
            LoadDG();
    }
    ...
    private void toolStripButton3_Click(object sender, EventArgs e)
    {
      try
      {
                databaseHandle.SendQueryMySql(Host, User, Password, Database, "INSERT INTO t_luckydrawResult (a_luckydraw_idx, a_item_idx, a_count, a_upgrade, a_prob, a_flag) VALUES (" + textBox1.Text + ", 19, 0, 0, 0, 0)");
      }
      catch
      {
        int num = (int) MessageBox.Show("Duplicated ItemID isn't allowed.", "Error");
    ...
    private void InitializeComponent()
    {
            ...
            this.listBox1.Size = new System.Drawing.Size(211, 511);
            ...
            this.button2.Location = new System.Drawing.Point(117, 548);
            ...
            this.button1.Location = new System.Drawing.Point(6, 548);
            ...
            this.button3.Location = new System.Drawing.Point(802, 560);
            ...
            this.groupBox4.Size = new System.Drawing.Size(441, 355);
            ...
            this.dgItems.Size = new System.Drawing.Size(435, 311);
            ...
            this.toolStrip2.Location = new System.Drawing.Point(3, 327);
            ...
            this.btnDeleteSelected.Size = new System.Drawing.Size(60, 22);
            ...
            this.groupBox3.Size = new System.Drawing.Size(614, 407);
            ...
            this.dgItems2.Size = new System.Drawing.Size(608, 363);
            ...
            this.toolStrip1.Location = new System.Drawing.Point(3, 379);
            ...
            this.tabPage1.Size = new System.Drawing.Size(628, 421);
            ...
            this.tabPage2.Size = new System.Drawing.Size(628, 421);
