...
// Type: DevPackMine.Tools.ShopEditor
...
namespace DevPackMine.Tools
{
  public class ShopEditor : Form
  {
    ...
    {
            databaseHandle.SendQueryMySql(Host, User, Password, Database, "UPDATE t_shop SET " + "a_keeper_idx = '" + textBox1.Text + "', " + "a_zone_num = '" + textBox2.Text + "', " + "a_name = '" + textBox3.Text + "', " + "a_sell_rate = '" + textBox4.Text + "', " + "a_buy_rate = '" + textBox5.Text + "', " + "a_pos_x = '" + textBox6.Text + "', " + "a_pos_z = '" + textBox7.Text + "', " + "a_pos_h = '" + textBox8.Text + "', " + "a_pos_r = '" + textBox9.Text + "', " + "a_y_layer = '" + textBox10.Text + "' " + "WHERE a_keeper_idx = '" + textBox11.Text + "'");
    ...
    {
            databaseHandle.SendQueryMySql(Host, User, Password, Database, "INSERT INTO t_shop DEFAULT VALUES");
            LoadListBox();
    ...
    private void btnAddItems_Click(object sender, EventArgs e)
    {
      try
      {
                databaseHandle.SendQueryMySql(Host, User, Password, Database, "INSERT INTO t_shopitem (a_keeper_idx, a_item_idx) VALUES (" + textBox1.Text + ", 19)");
      }
      catch
      {
    ...
    private void InitializeComponent()
    {
            ...
            this.exportToolStripMenuItem.Size = new System.Drawing.Size(73, 20);
            ...
            this.exportlodToolStripMenuItem.Size = new System.Drawing.Size(152, 22);
