...
// Type: DevPackMine.Tools.MoonstoneEditor
...
namespace DevPackMine.Tools
{
  public class MoonstoneEditor : Form
  {
    ...
    private void Exporter_Moonstone2_Load_1(object sender, EventArgs e)
    {
    }
    ...
    private void btnAddItems_Click(object sender, EventArgs e)
    {
      try
      {
                databaseHandle.SendQueryMySql(Host, User, Password, Database, "INSERT INTO t_moonstone_reward (a_type, a_giftindex) VALUES ('" + MoonstoneID + "', '19')");
      }
      catch
      {
