...
// Type: DevPackMine.Tools.TitleEditor
...
namespace DevPackMine.Tools
{
  public class TitleEditor : Form
  {
    ...
    {
            //exportLodHandle.ExportTitle_V4();
            string text1 = "title";
    ...
    private void InitializeComponent()
    {
            ...
            this.exportlodToolStripMenuItem.Size = new System.Drawing.Size(130, 22);
            ...
            this.clickMeBeforeEditingTitlesToolStripMenuItem.Size = new System.Drawing.Size(179, 20);
        ...
        private void PbSelectID1_Click(object sender, EventArgs e) //dethunter12 add 6/10/2018
        {
            ...
            if (itemPicker.ShowDialog() != DialogResult.OK)
                return;
            textBox21.Text = itemPicker.ItemIndex.ToString();
        }
    }
}
