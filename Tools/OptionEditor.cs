...
// Type: DevPackMine.Tools.OptionEditor
  ...
  public class OptionEditor : Form
  {
    ...
    public void LoadDG()
    {
      ...
      while (mySqlDataReader.Read())
      {
        ...
        {
            // if lArrayLevel not exist add new item with value 0
            if (lArrayLevel.Count < count)
            {
                lArrayLevel.Add("0");
            }
            // if lArrayProb not exist add new item with value 0
            if (lArrayProb.Count < count)
            {
                    lArrayProb.Add("0");
            }
    ...
    {
            //exportLodHandle.ExportOption_V4();
            string text1 = "option";
    ...
    private void InitializeComponent()
    {
            ...
            this.exportlodToolStripMenuItem.Size = new System.Drawing.Size(172, 22);
            ...
            this.exportStrOptionlodToolStripMenuItem.Size = new System.Drawing.Size(172, 22);
            ...
            this.btnDeleteSelected.Size = new System.Drawing.Size(63, 22);
            ...
            this.btnAddItems.Size = new System.Drawing.Size(58, 22);
