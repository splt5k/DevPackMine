...
// Type: DevPackMine.ExportLodHandle
  ...
  public class ExportLodHandle
  {
    ...
    public void ExportString_V4(string fileType)
    {
      ...
      while (mySqlDataReader.Read())
      {
        ...
        if (flag2)
        {
          int ordinal3 = mySqlDataReader.GetOrdinal("a_descr");
          string s3 = mySqlDataReader.GetString(ordinal3);
    ...
    public void ExportShop_V4()
    {
      ...
      while (mySqlDataReader1.Read())
      {
        ...
        binaryWriter.Write(num2);
        string str2 = "SELECT t1.a_item_idx AS itemindex FROM t_shopitem t1, t_item t2 WHERE t1.a_keeper_idx=" + s1 + " AND t1.a_item_idx=t2.a_index ORDER BY t2.a_job_flag, t2.a_level, t2.a_type_idx, t2.a_subtype_idx, t2.a_index";
        MySqlConnection mySqlConnection2 = new MySqlConnection(connectionString);
        MySqlCommand command2 = mySqlConnection2.CreateCommand();
